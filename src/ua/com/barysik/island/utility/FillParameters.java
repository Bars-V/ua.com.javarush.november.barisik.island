...
public class FillParameters {
    ...
    private static String anaconda = Bush.CarnivorousBush.class.getSimpleName();
    private static String fox = Bush.CarnivorousBush.class.getSimpleName();
...
//        Parameters.setParameterDouble(Constants.satiety, anaconda, 3.0);
//        Parameters.setParameterDouble(Constants.satiety, fox, 3.0);
